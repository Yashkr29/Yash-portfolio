...
function Hero() {
  return (
    <section id="home" className="relative min-h-screen scroll-mt-24 overflow-hidden pt-24">
      ...
      <div className="section-shell grid min-h-[calc(100vh-96px)] items-center gap-10 py-12 sm:py-16 lg:grid-cols-[1.04fr_0.96fr] lg:gap-12 lg:py-10">
        <motion.div
          initial={{ opacity: 0, y: 28 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7, ease: 'easeOut' }}
        >
          <div className="mb-6 inline-flex max-w-full items-center gap-2 rounded-md border border-cyan-300/20 bg-cyan-300/8 px-4 py-2 text-sm text-cyan-100">
            <Sparkles size={16} />
          ...
          <div className="mt-8 grid gap-3 sm:flex sm:flex-wrap">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-md border border-cyan-300/30 bg-cyan-300/10 px-5 py-3 font-semibold text-cyan-100 transition hover:-translate-y-1 hover:border-cyan-200/60 hover:bg-cyan-300/16"
            >
            ...
            <button
              ...
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-md border border-white/12 bg-white/8 px-5 py-3 font-semibold text-white transition hover:-translate-y-1 hover:bg-white/12"
            >
        ...
        <motion.div
          className="relative min-h-[390px] sm:min-h-[440px]"
